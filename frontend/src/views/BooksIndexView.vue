...
const filteredBooks = ref(BookService.getBooksByCategory());
const selectorCategories = BookService.getUniqueBookCategories();
const selectedCategory = ref('');

watch(selectedCategory, (newCategory) => {
  filteredBooks.value = BookService.getBooksByCategory(newCategory || undefined);
});
</script>
          ...
          >
            ...
            <div class="bg-gray-50 rounded-lg p-3 mb-4">
              <div class="flex justify-between text-sm">
                ...
                <span class="font-semibold">${{ PriceService.formatToCOP(book.price) }}COP</span>
              </div>
            </div>
